...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        h, h_cache = affine_relu_forward(a, W2, b2)
        scores, o_cache = affine_forward(h, W3, b3)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dout, o_cache)
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, h_cache)
        dout, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout, a_cache)
